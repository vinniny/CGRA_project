...
task automatic test_multicast_partial_grant;
    ...
    //   tb_top.u_dut.u_array.u_tile_00.u_router
    ...
    force tb_top.u_dut.u_array.tile_10_n_ready = 1'b0;
    ...
    force tb_top.u_dut.u_array.u_tile_00.u_router.b_val_n = 1'b1;
    force tb_top.u_dut.u_array.u_tile_00.u_router.b_data_n = MCAST_PKT;
    force tb_top.u_dut.u_array.u_tile_00.u_router.served_n = 5'b00000;
    ...
    if (tb_top.u_dut.u_array.u_tile_00.u_router.valid_out_e !== 1'b1) begin
        $error("[MCAST_PARTIAL] FAIL: East not granted after injection");
        fail_count++;
    end

    // CHECK 2: Buffer must stall (South is blocked)
    if (tb_top.u_dut.u_array.u_tile_00.u_router.stall_n !== 1'b1) begin
    ...
    release tb_top.u_dut.u_array.u_tile_00.u_router.served_n;
    @(posedge clk); #1;
    ...
    if (tb_top.u_dut.u_array.u_tile_00.u_router.valid_out_e !== 1'b0) begin
    ...
    if (tb_top.u_dut.u_array.u_tile_00.u_router.valid_out_s !== 1'b1) begin
    ...
    force tb_top.u_dut.u_array.tile_10_n_ready = 1'b1;
    #1; // Let combinational logic settle

    // CHECK 6: Stall should clear now (South can be delivered)
    if (tb_top.u_dut.u_array.u_tile_00.u_router.stall_n !== 1'b0) begin
    ...
    release tb_top.u_dut.u_array.tile_10_n_ready;
    release tb_top.u_dut.u_array.u_tile_00.u_router.b_val_n;
    release tb_top.u_dut.u_array.u_tile_00.u_router.b_data_n;
    release tb_top.u_dut.u_array.u_tile_00.u_router.served_n;
