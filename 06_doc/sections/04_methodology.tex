...
The CGRA IP is integrated into the Programmable Logic of the Xilinx Zynq-7000 XC7Z020 SoC. To overcome the common ``bottleneck black hole'' found in standard accelerator designs, this project proposes a \textbf{Hybrid I/O architecture} that decouples data and control paths:
\begin{itemize}
    \item \textbf{AXI4 Data Plane (DMA):} Facilitates high-bandwidth, burst-oriented communication with DDR3 DRAM for weight and spike streaming.
