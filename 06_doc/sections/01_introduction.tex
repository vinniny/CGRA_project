...
The CGRA is designed as a tightly integrated hardware accelerator under full control of an ARM Cortex-A53 subsystem. The typical execution flow consists of:
\begin{enumerate}
...
The system architecture and DMA engine are designed according to the AMBA AXI Standard \cite{arm_amba_axi}, ensuring interoperability with the Zynq UltraScale+ processing system \cite{xilinx_ug1085}.
